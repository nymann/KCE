...
namespace KCE.BoardRepresentation
{
    public class MoveGenerator
    {
                ...
                foreach (int square in _board64)
                {
                    ...
                    switch (_boardState.BoardRepresentation[square])
                    {
                        ...
                        case Definitions.WhiteKing:
                            ...
                            {
                                Ply ply;
                                if (_boardState.WhiteCanCastleKingSide && psuedoLegalMove == 22)
                                {
                                ...
                                else if (_boardState.WhiteCanCastleQueenSide && psuedoLegalMove == 26)
                                {
                                    // perform white queenside castling
                                    ply = helper.MakePly(_boardState.BoardRepresentation, square, psuedoLegalMove,
        ...
        private void UpdateKingSquares()
        {
            ...
            {
                // Temp. solution.
                // King square is not up to date. Setting it.
